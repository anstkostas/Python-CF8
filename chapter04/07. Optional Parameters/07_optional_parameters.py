# Python doesnt have parameter overloading, this is "handled" by providing default values. With this the positional parameters become named parameters(or optional).
...
def main():
    ...
    print(add(100))  # TypeError: add() missing 1 required positional arguments: 'b'.
